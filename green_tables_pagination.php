...
<BODY BGCOLOR="#FFFFFF" TEXT="#000000" LINK="#FF0000" VLINK="#800000" ALINK="#FF00FF" BACKGROUND="?">
		...
		<div>
			...
			<ul class="pagination modal-2">	  
				...
				?>
				<li><a href="green_tables_pagination.php?page=<?php echo $prev_set ?>"><?php echo "Prev Set" ?></a></li>
				<?php if ($page == 0) { $page=1; }
				...
				<?php $page=$page+1; ?>
					<li><a href="green_tables_pagination.php?page=<?php echo $page ?>"><?php echo "Next Set" ?></a></li>
				<?php } ?>
			</ul>	
			<?php } 
			?>			
